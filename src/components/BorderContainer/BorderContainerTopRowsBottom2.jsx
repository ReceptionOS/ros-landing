  ...
  return (
    <>
      ...
      >
        <path
          opacity="0.3"
          d="M961 1V15L933 24.9999H875.5L844.5 30.9999V24.9999L30 25.1339L1 15.134V1.13397"
          stroke="#877B72"
          strokeLinecap="round"
        />
      </svg>
      <svg
        className="top-rows-bottom2-bottom mobile"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 360 32"
        fill="none"
      >
        <path
          opacity="0.3"
          d="M359 1V15L331 24.9999H273.5L242.5 30.9999V24.9999H30L1 15V1"
          stroke="#877B72"
          strokeLinecap="round"
        />
      </svg>
