...
export const BorderContainer4RowsCornersOnly = ({ children, className }) => {
  return (
    <div className={`border-container-4-rows-corners-only ${className}`}>
      <svg
        className="left-top"
      ...
      {children}
      <style jsx="true">{`
        .border-container-4-rows-corners-only {
          position: relative;
