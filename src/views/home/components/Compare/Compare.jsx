...
import VimeoWithPlayButton from "../../../../components/VimeoWithPlayButton/VimeoWithPlayButton";

const Compare = ({ t }) => {
  const [open, setOpen] = useState(true);
  const videoRef = useRef(null);

  const handleTabSwitch = (newState) => {
    if (open && !newState && videoRef.current) {
    ...
    <div className="container">
      <CompareComponent>
        ...
        <div className="compare-buttons-container">
          <div onClick={() => handleTabSwitch(true)} className={open ? "compare-sides compare-left" : "compare-sides compare-left compare-inactive"}>
            {t('home.Compare.button-with')}
          </div>
          <div onClick={() => handleTabSwitch(false)} className={!open ? "compare-sides compare-right" : "compare-sides compare-right compare-inactive"}>
