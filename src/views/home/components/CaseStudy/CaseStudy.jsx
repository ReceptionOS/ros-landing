...
const CaseStudy = ({ t }) => {
      ...
      <CsModalContainer>
          ...
          {["1", "2", "3"].map(key => (
            ...
            >
              ...
              <div className="text-con">
                <p style={{ color: "#FFE8D9" }} className="p-new-model-16">
                  {t(`home.CaseStudy.modal.title-warning${key}`)}
                </p>
                <p className="p-new-model-16">
                  {t(`home.CaseStudy.modal.description-warning${key}`)}
                </p>
              </div>
            </div>
          ))}
        ...
        <BorderContainer4Rows className="cs-modal cs-modal-3">
          <p className="p-new-model-18">
            {t(`home.CaseStudy.modal.solution-title`)}
          </p>
        </BorderContainer4Rows>
        <BorderContainer4Rows className="cs-modal cs-modal-2">
          {["1", "2"].map(key => (
            ...
            >
              ...
              >
                <path
                  d="M2.83209 16C2.29689 14.7751 2 13.4222 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C9.74835 22 7.67051 21.2558 5.99902 20M8.5 12.5L11 15L16.5 9.5"
                  stroke="#37FF76"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
              ...
              <div className="text-con">
                <p style={{ color: "#FFE8D9" }} className="p-new-model-16">
                  {t(`home.CaseStudy.modal.title-solution${key}`)}
                </p>
                <p className="p-new-model-16">
                  {t(`home.CaseStudy.modal.description-solution${key}`)}
                </p>
              </div>
            </div>
          ))}
  ...
  return (
    <>
      <BaseModal isModal={isModal} props={props} modalStyles={modalStyles} />
      <CaseStudyComponent>
        <div className="container">
          <StaticImage
          ...
          <div className="case-study-top">
            ...
            <p className="p-new-model-16">{t("home.CaseStudy.description")}</p>
          </div>
          <StaticImage
            className="apolonia-cs"
            src="../../../../images/case-study/apolonia-logo.webp"
