      ...
      <div className="container">
        <PriceListComponent>
          <div className="top-container">
            ...
            <p style={{ marginTop: "20px" }} className="p-new-model-18">
              {t("home.PriceList.chairs")}
            </p>
          </div>
            ...
            <BorderContainerBottomRowsTop className="top-border-container">
              <div className="counter-container">
                <div
                  ...
                  className="counter-sides counter-left"
                >
                  <svg
                  ...
                  >
                    <path
                      d="M4.16675 10H10.0001H15.8334"
                      stroke="#FFE8D9"
                      strokeLinejoin="round"
                    />
                  </svg>
                </div>
                <div className="counter-middle">{counter}</div>
                <div
                  onClick={incrementCounter}
                  className="counter-sides counter-right"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                  ...
                  >
                    <path
                      d="M4.16675 10.0003H10.0001M15.8334 10.0003H10.0001M10.0001 10.0003V4.16699M10.0001 10.0003V15.8337"
                      stroke="#FFE8D9"
                      strokeLinejoin="round"
                    />
                  </svg>
                ...
                return (
                  <BorderContainer4Rows key={index} className="price-tile">
                    ...
                    <div className="price-bottom">
                      <h3>
                        {computed} PLN{" "}
                        <span>/ {t(`home.PriceList.month`)}</span>
                      </h3>

                      {item.listText && (
                        <p className="list-text">
                          {t(`home.PriceList.${item.name}-list-text`)}
                        </p>
                      )}
                      ...
                      {item.list.map(key => (
                        <div key={key} className="price-li">
                          ...
                          >
                            <path
                              d="M3.33325 10.8333L7.49992 15L16.6666 5"
                              stroke="#FFE8D9"
                              strokeLinejoin="round"
                            />
                          </svg>
                          <p className="p-new-model-16 ">
                            {t(`home.PriceList.${item.name}-li${key}`)}
                          </p>
                        </div>
                      ))}
                    </div>
